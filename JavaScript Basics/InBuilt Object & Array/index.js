...
let firstName = new String("Kashif");
...
console.log(firstName.includes("Kas"));
console.log(firstName.startsWith("Kas"));
console.log(firstName.endsWith("Kas"));
console.log(firstName[0]);
let anotherName = firstName.replace("Kashi", "kashu") + "i";
...
arr.push(10);
arr.unshift(0);
arr.splice(4, 0, "Kashif"); //index numberOfDeletedElements ValueInserted
...
let course = courses.find(function(course) {
    return course.NAme === "Kashif";
});

console.log(course);

course = courses.find(function(course) {
    return course.NAme === "Bholo";
});

console.log(course);

course = courses.find(course => course.NAme === "Kashif");
console.log(course);
